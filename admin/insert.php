<?php
    ...
    if(!empty($_POST)) 
    {
        ...
        {
            $db = Database::connect();
            $statement = $db->prepare("INSERT INTO products (p_name,p_description,p_price,p_category,p_image) values(?, ?, ?, ?, ?)");
            ...
            <div class="row">
                ...
                <form class="form" action="insert.php" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        <p><button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> Agregar</button>
                        </p>
